...
{{--                    @endphp--}}
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    <!--begin::Menu Nav-->
                    <ul class="menu-nav">
                        <li class="menu-item menu-item-submenu {{ Request::is('admin/dashboard*') ? 'active': '' }}" aria-haspopup="true">
                        ...
                        <li class="menu-item menu-item-submenu {{ Request::is('admin/admins*') ? 'active': '' }}" aria-haspopup="true">
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true">
                            <a href="{{route('orders.index')}}" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">{{__('dashboard.Orders')}} <span class="menu-label">
														<span class="label label-rounded label-primary">{{\App\Models\Order::where('status',0)->whereNotNull('provider_id')->count()}}</span>
													</span></span>
                            </a>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true">
                            <a href="{{route('orders-management.index')}}" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">{{__('dashboard.orders management')}} <span class="menu-label">
														<span class="label label-rounded label-primary">{{\App\Models\Order::where('status',0)->whereNull('provider_id')->count()}}</span>
													</span></span>
                            </a>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true">
                            <a href="{{route('contacts.index')}}" class="menu-link menu-toggle">
                                ...
                                <span class="menu-label">
														<span class="label label-rounded label-primary">{{\App\Models\ContactUs::where('read',0)->count()}}</span>
													</span>
                                </span>
                            </a>
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-item">
                            <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                ...
                                <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{\Illuminate\Support\Facades\Auth::guard('admin')->user()->name}}</span>
                                <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
											<span class="symbol-label font-size-h5 font-weight-bold">{{mb_substr(\Illuminate\Support\Facades\Auth::guard('admin')->user()->name,0, 1)}}</span>
										</span>
                            </div>
                        </div>
                        <!--end::User-->
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label">
                    <img src="{{ \Illuminate\Support\Facades\Auth::guard('admin')->user()->image }}" style="max-width: 100px">
                </div>
            ...
            <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                ...
                <div class="mb-15">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('assets/dist/assets/media/svg/misc/006-plurk.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
                        </div>
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('assets/dist/assets/media/svg/misc/015-telegram.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('assets/dist/assets/media/svg/misc/003-puzzle.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('assets/dist/assets/media/svg/misc/005-bebo.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('assets/dist/assets/media/svg/misc/014-kickstarter.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
