                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                @can('admins.edit')
                                <a href="" class="text-muted">{{__('dashboard.Edit Admin')}}</a>
                                @endcan
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-header py-3">
                                <div class="card-title align-items-start flex-column">
                                    <h3 class="card-label font-weight-bolder text-dark">{{__('dashboard.Edit Admin')}}</h3>
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">{{__('dashboard.Edit admin account settings')}}</span>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="{{__('dashboard.Name')}}" name="name" value="{{$admin->name}}"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group input-group-lg input-group-solid">
                                                ...
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="email" placeholder="{{__('dashboard.Email')}}" value="{{$admin->email}}"/>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="image-input image-input-outline" id="kt_image_1">
                                                <div class="image-input-wrapper" style="background-image: url({{$admin->image}})"></div>
