            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">{{__('dashboard.Admins')}}</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">{{__('dashboard.Admins Data')}}</h3>
                        </div>
...
{{--                                <td nowrap="nowrap">--}}
{{--                                    <a href="{{route('admins.edit',$admin->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">--}}
...
{{--                                        @csrf--}}
{{--                                    <button type="submit" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3" style="margin-top: 10px">--}}
{{--																		<span class="svg-icon svg-icon-md svg-icon-primary">--}}
