                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="{{__('dashboard.Name AR')}}" name="ar[name]" value="{{$service->translate('ar')->name}}"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="{{__('dashboard.Name EN')}}" name="en[name]" value="{{$service->translate('en')->name}}"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-9 col-sm-12">
                                            <textarea name="ar[desc]" id="kt-ckeditor-1">{{$service->translate('ar')->desc}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-9 col-sm-12">
                                            <textarea name="en[desc]" id="kt-ckeditor-2">{{$service->translate('en')->desc}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="image-input image-input-outline" id="kt_image_1">
                                                <div class="image-input-wrapper" style="background-image: url({{$service->icon}})"></div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <select name="status" class="form-control form-control-lg form-control-solid">
                                                <option @if($service->status=='0') selected @endif value="0">{{__('dashboard.no')}}</option>
                                                <option @if($service->status=='1') selected @endif value="1">{{__('dashboard.yes')}}</option>
                                            </select>
                                        </div>
                                    </div>
