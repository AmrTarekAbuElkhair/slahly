                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-header py-3">
                                <div class="card-title align-items-start flex-column">
                                    <h3 class="card-label font-weight-bolder text-dark">{{__('dashboard.Edit instruction')}}</h3>
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">{{__('dashboard.Edit instruction data')}}</span>
                                </div>

                            </div>
                            <!--end::Header-->
                            <!--begin::Form-->
                            <form class="form" action="{{route('instructions.update',$instruction->id)}}" method="post" >
                                @csrf
                                <div class="card-body">
                                    <!--begin::Heading-->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-9 col-sm-12">
                                            <textarea class="ckeditor form-control" name="en_text">{{$instruction->getTranslation('en')->text}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-9 col-sm-12">
                                            <textarea class="ckeditor form-control" name="ar_text">{{$instruction->getTranslation('ar')->text}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <select name="status" class="form-control form-control-lg form-control-solid">
                                                <option value="0" @if($instruction->status=='0')selected @endif>{{__('dashboard.no')}}</option>
                                                <option value="1" @if($instruction->status=='1')selected @endif>{{__('dashboard.yes')}}</option>
                                            </select>
                                        </div>
                                    </div>
