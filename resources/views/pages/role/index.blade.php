            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">{{__('dashboard.roles')}}</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">{{__('dashboard.roles Data')}}</h3>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover" id="myTable"
                            ...
                            {{--                                    <td>{{$city->name}}</td>--}}
                            {{--                                    <td nowrap="nowrap">--}}
                            {{--                                        <a href="{{route('cities.edit',$city->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">--}}
