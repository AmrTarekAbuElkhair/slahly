                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="" class="text-muted">{{__('dashboard.Providers')}}</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            ...
                            <form action="{{route('providers.all.delete')}}" method="post" style="margin-left: 10px">
                                @csrf
                                <input id='deleteProvidersBtn' type="submit" class="btn btn-primary mr-2" value="delete all providers" disabled />
