                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="" class="text-muted">{{__('dashboard.Create Country')}}</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-header py-3">
                                <div class="card-title align-items-start flex-column">
                                    <h3 class="card-label font-weight-bolder text-dark">{{__('dashboard.Create Country')}}</h3>
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">{{__('dashboard.create new country')}}</span>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="{{__('dashboard.Name in english')}}" name="en[name]" required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="{{__('dashboard.Name in arabic')}}" name="ar[name]" required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="number" placeholder="{{__('dashboard.digits')}}" name="digits" required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="number" placeholder="{{__('dashboard.code')}}" name="code" required/>
