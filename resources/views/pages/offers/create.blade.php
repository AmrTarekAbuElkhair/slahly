                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-header py-3">
                                <div class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">{{__('dashboard.create new offer')}}</span>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="{{__('dashboard.percentage')}}" name="percentage"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="{{__('dashboard.price_before_sale')}}" name="price_before_sale"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder="{{__('dashboard.price_after_sale')}}" name="price_after_sale"/>
