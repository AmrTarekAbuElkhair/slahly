...
class Role extends Model implements RoleContract
{
    ...
    public static function create(array $attributes = [])
    {
        ...
        $params = ['name_en' => $attributes['name_en'],'name_ar' => $attributes['name_ar'] ,'guard_name' => $attributes['guard_name']];
        ...
        if (static::findByParam($params)) {
            throw RoleAlreadyExists::create($attributes['name_en'],$attributes['name_ar'], $attributes['guard_name']);
        }
    ...
    public static function findByName(string $name, $guardName = null): RoleContract
    {
        ...
        $role = static::findByParam(['name_en' => $name,'name_ar' => $name ,'guard_name' => $guardName]);
    ...
    public static function findOrCreate(string $name,$guardName = null): RoleContract
    {
        ...
        if (! $role) {
            return static::query()->create(['name_en' => $name,'name_ar' => $name ,'guard_name' => $guardName] + (PermissionRegistrar::$teams ? [PermissionRegistrar::$teamsKey => getPermissionsTeamId()] : []));
        }
